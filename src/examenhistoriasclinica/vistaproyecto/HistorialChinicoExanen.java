 ...
 * @author bmcue
 */
public class HistorialChinicoExanen extends javax.swing.JFrame {

    /**
     * Creates new form HistorialChinicoExanen
     */
    public HistorialChinicoExanen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabbedPane3.getAccessibleContext().setAccessibleParent(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistorialChinicoExanen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistorialChinicoExanen().setVisible(true);
            }
        });
    }
